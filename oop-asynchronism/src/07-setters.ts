export class MyDate {
  ...
  /*
    A setter is a special type of method that acts as a write-only property.
    A setter is defined using the "set" keyword, and its value is updated
...
const myDate = new MyDate(2022, 5, 22);
